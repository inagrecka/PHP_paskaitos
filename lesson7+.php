...
//var_dump(getShoppingCart());
// Visose užduotyse naudokite array funkcijas

function exercise1($shoppingCart): void
{
    /*
    ...
    */
    ...
    var_dump(implode(', ', array_keys($shoppingCart['products'])));
}
exercise1(getShoppingCart());

function exercise2($shoppingCart): float
{
    /*
    ...
    */
    $newArr = $shoppingCart['products'];

    $totalPrice = array_reduce(
        $newArr,
        function (float $carry, array $item) {
...
var_dump(exercise2(getShoppingCart()));
